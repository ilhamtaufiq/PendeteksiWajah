...
public class facedetection extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        webSource = new VideoCapture(0); // mengambil gambar dari kamera
        myThread = new DaemonThread(); // membuat objek
        Thread t = new Thread(myThread);
        t.setDaemon(true);
        myThread.runnable = true;
        t.start();                 //mulai thread
        jButton1.setEnabled(false);  // nonaktif tombil start 
        jButton2.setEnabled(true);  //  aktif tombol stop 
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        myThread.runnable = false;            // stop thread
        jButton2.setEnabled(false);   // aktif tombol start  
        jButton1.setEnabled(true);     // nonaktif tombol stop 

        webSource.release();  // stop kamera
